 ...
 * - getTypeName
 *
 * Returning a string that is used as the first URI segment and maps
 * to the typeNum.
 *
 ...
 *
 * @package TYPO3
 * @subpackage ExtbaseRealurl
 */
interface Tx_ExtbaseRealurl_RoutableControllerInterface extends Tx_Extbase_MVC_Controller_ControllerInterface {
